function applyaBMDC(pe1_dir, pe2_dir, results_dir)
...
if (contains(pe1, 'LR') || contains(pe2, 'LR'))
    ...
    correction_field_dir = [results_dir, 'b0_LRRL_aBMDC_correction_field.nii.gz'];
        
elseif (contains(pe1, 'AP') || contains(pe2, 'AP'))
    
    correction_field_dir = [results_dir, 'b0_APPA_aBMDC_correction_field.nii.gz'];
